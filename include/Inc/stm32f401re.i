 ...
 * @file           : stm32f401re.i
 * @author         : Ian Church
 * @brief          : definitions for stm32f401re Nucleo-54
 ******************************************************************************
 * @attention
 *
...
RCC_PLLCFGR_PLLR_2	=		0x00 << 28
RCC_PLLCFGR_PLLR_4	=		0x01 << 28
RCC_PLLCFGR_PLLR_6	=		0x02 << 28
RCC_PLLCFGR_PLLR_8	=		0x03 << 28

RCC_PLLCFGR_PLLQ_Pos=		24
RCC_PLLCFGR_PLLQ_Msk=		0xf
RCC_PLLCFGR_PLLQ	=		(RCC_PLLCFGR_PLLQ_Msk << RCC_PLLCFGR_PLLQ_Pos)


RCC_PLLCFGR_PLLSRC	=		0x01 << 22

RCC_PLLCFGR_PLLP_Pos=		16
RCC_PLLCFGR_PLLP_Msk=		0x03
RCC_PLLCFGR_PLLP_DIV2=		0x00
RCC_PLLCFGR_PLLP_DIV4=		0x01
RCC_PLLCFGR_PLLP_DIV6=		0x02
RCC_PLLCFGR_PLLP_DIV8=		0x03
RCC_PLLCFGR_PLLP	=		(RCC_PLLCFGR_PLLP_Msk << RCC_PLLCFGR_PLLP_Pos)


RCC_PLLCFGR_PLLN_Pos=		6
RCC_PLLCFGR_PLLN_Msk=		0x1ff
RCC_PLLCFGR_PLLN	=		(RCC_PLLCFGR_PLLN_Msk << RCC_PLLCFGR_PLLN_Pos)

RCC_PLLCFGR_PLLM_Pos=		0
RCC_PLLCFGR_PLLM_Msk=		0x7F
RCC_PLLCFGR_PLLM	=		(RCC_PLLCFGR_PLLM_Msk << RCC_PLLCFGR_PLLM_Pos)



AHB1ENR_OFFSET		=		0x30
RCC_AHB1ENR			=		RCC_BASE + AHB1ENR_OFFSET
...
RCC_CFGR_SW_HSI16		=	0x00 << 0
RCC_CFGR_SW_HSE			=	0x01 << 0
RCC_CFGR_SW_PLL			=	0x02 << 0

RCC_CFGR_SW0			=	0x01 << 0
RCC_CFGR_SW1			=	0x01 << 1
RCC_CFGR_SWS0			=	0x01 << 2
RCC_CFGR_SWS1			=	0x01 << 3

RCC_CFGR_HPRE_Pos		=	4
RCC_CFGR_HPRE_Msk		=	(0x0f << RCC_CFGR_HPRE_Pos)
RCC_CFGR_HPRE			=	RCC_CFGR_HPRE_Msk

RCC_CFGR_PPRE1_Pos		=	10
RCC_CFGR_PPRE1_Msk		=	(0x07 << RCC_CFGR_PPRE1_Pos)
RCC_CFGR_PPRE1			=	RCC_CFGR_PPRE1_Msk

RCC_CFGR_PPRE2_Pos		=	13
RCC_CFGR_PPRE2_Msk		=	(0x07 << RCC_CFGR_PPRE2_Pos)
RCC_CFGR_PPRE2			=	RCC_CFGR_PPRE2_Msk

RCC_CFGR_RTCPRE_Pos		=	16
RCC_CFGR_RTCPRE_Msk		=	(0x1f << RCC_CFGR_RTCPRE_Pos)
RCC_CFGR_RTCPRE			=	RCC_CFGR_RTCPRE_Msk

RCC_CFGR_MCO1_Pos		=	21
RCC_CFGR_MCO1_Msk		=	(0x03 << RCC_CFGR_MCO1_Pos)
RCC_CFGR_MCO1			=	RCC_CFGR_MCO1_Msk

RCC_CFGR_MCO1SEL_HSI		=	(0x00 << RCC_CFGR_MCO1_Pos)
RCC_CFGR_MCO1SEL_LSE		=	(0x01 << RCC_CFGR_MCO1_Pos)
RCC_CFGR_MCO1SEL_HSE		=	(0x02 << RCC_CFGR_MCO1_Pos)
RCC_CFGR_MCO1SEL_PLL		=	(0x03 << RCC_CFGR_MCO1_Pos)

RCC_CFGR_I2SSCR			=	0x01 << 23

RCC_CFGR_MCO1PRE_Pos	=	24
RCC_CFGR_MCO1PRE_Msk	=	(0x07 << RCC_CFGR_MCO1PRE_Pos)
RCC_CFGR_MCO1PRE		=	RCC_CFGR_MCO1PRE_Msk
RCC_CFGR_MCO1PRE_DIV_2	=	(0x04 << RCC_CFGR_MCO1PRE_Pos)
RCC_CFGR_MCO1PRE_DIV_3	=	(0x05 << RCC_CFGR_MCO1PRE_Pos)
RCC_CFGR_MCO1PRE_DIV_4	=	(0x06 << RCC_CFGR_MCO1PRE_Pos)
RCC_CFGR_MCO1PRE_DIV_5	=	(0x07 << RCC_CFGR_MCO1PRE_Pos)

RCC_CFGR_MCO2PRE_Pos	=	27
RCC_CFGR_MCO2PRE_Msk	=	(0x07 << RCC_CFGR_MCO2PRE_Pos)
RCC_CFGR_MCO2PRE		=	RCC_CFGR_MCO2PRE_Msk
RCC_CFGR_MCO2PRE_DIV_2	=	(0x04 << RCC_CFGR_MCO2PRE_Pos)
RCC_CFGR_MCO2PRE_DIV_3	=	(0x05 << RCC_CFGR_MCO2PRE_Pos)
RCC_CFGR_MCO2PRE_DIV_4	=	(0x06 << RCC_CFGR_MCO2PRE_Pos)
RCC_CFGR_MCO2PRE_DIV_5	=	(0x07 << RCC_CFGR_MCO2PRE_Pos)


RCC_CFGR_MCO2_Pos		=	30
RCC_CFGR_MCO2_Msk		=	(0x03 << RCC_CFGR_MCO2_Pos)
RCC_CFGR_MCO2			=	RCC_CFGR_MCO2_Msk

RCC_CFGR_MCO2SEL_SYSCLK	=	(0x00 << RCC_CFGR_MCO2_Pos)
RCC_CFGR_MCO2SEL_PLLI2S	=	(0x01 << RCC_CFGR_MCO2_Pos)
RCC_CFGR_MCO2SEL_HSE	=	(0x02 << RCC_CFGR_MCO2_Pos)
RCC_CFGR_MCO2SEL_PLL	=	(0x03 << RCC_CFGR_MCO2_Pos)
...
RCC_CRRCR_HSI48RDY	=		1<<1			@ RCC_CRRCR->HSIRDY
RCC_CRRCR_HSI48ON	=		1<<0			@ RCC_CRRCR->HSION
...
I2C_SR2_OFFSET		=		(0x18)
I2C_CCR_OFFSET		=		(0x1c)
I2C_TRISE_OFFSET	=		(0x20)
I2C_FLTR_OFFSET		=		(0x24)
...
I2C_SR2_DUALF		=		(1 << 7)
I2C_SR2_PEC_Pos		=		8
I2C_SR2_PEC_Msk		=		(0xff << I2C_SR2_PEC_Pos)
...
@
I2C_CR2_FREQ_Pos		=	0
I2C_CR2_FREQ_Msk		=	(0x3f << I2C_CR2_FREQ_Pos)
I2C_CR2_FREQ			=	I2C_CR2_FREQ_Msk
I2C_CR2_ITERREN			=	(1 << 8)
I2C_CR2_ITEVTEN			=	(1 << 9)
I2C_CR2_ITBUFFEN		=	(1 << 10)
I2C_CR2_DMAEN			=	(1 << 11)
I2C_CR2_LAST			=	(1 << 12)

@
@ I2C OAR1 definitions
@
I2C_OAR1_OA1EN			=	(1 << 15)
...
@
I2C_CCR_CCR_Pos			=	0
I2C_CCR_CCR_Msk			=	(0x7ff << I2C_CCR_CCR_Pos)
I2C_CCR_CCR				=	I2C_CCR_CCR_Msk
I2C_CCR_DUTY			=	(1 << 14)
I2C_CCR_FS				=	(1 << 15)

@
@ I2C TRISE definitions
@
I2C_TRISE_TRISE_Pos		=	0
I2C_TRISE_TRISE_Msk		=	(0x1f << I2C_TRISE_TRISE_Pos)
I2C_TRISE				=	I2C_TRISE_TRISE_Msk
...
GPIOC_MODER			=		GPIOC_BASE + GPIO_MODER_OFFSET
...
GPIOB_OTYPER			=	GPIOB_BASE + GPIO_OTYPER_OFFSET
GPIOC_OTYPER			=	GPIOB_BASE + GPIO_OTYPER_OFFSET
...
GPIOB_OSPEED			=	GPIOB_BASE + GPIO_OSPEED_OFFSET
GPIOC_OSPEED			=	GPIOC_BASE + GPIO_OSPEED_OFFSET
...
GPIOB_PUPDR				=	GPIOB_BASE + GPIO_PUPDR_OFFSET
GPIOC_PUPDR				=	GPIOC_BASE + GPIO_PUPDR_OFFSET
...
@
@ RCC_AHB1ENR AHB1 Peripheral clock enable register values
@
RCC_AHB1ENR_GPIOA_EN	=		1<<0   	@ GPIOA Enable
RCC_AHB1ENR_GPIOB_EN	=		1<<1   	@ GPIOB Enable
RCC_AHB1ENR_GPIOC_EN	=		1<<2   	@ GPIOC Enable
RCC_AHB1ENR_GPIOD_EN	=		1<<3   	@ GPIOD Enable
RCC_AHB1ENR_GPIOE_EN	=		1<<4   	@ GPIOE Enable
RCC_AHB1ENR_GPIOF_EN	=		1<<5   	@ GPIOF Enable
RCC_AHB1ENR_GPIOG_EN	=		1<<6   	@ GPIOG Enable
RCC_AHB1ENR_GPIOH_EN	=		1<<7   	@ GPIOH Enable
RCC_AHB1ENR_GPIOI_EN	=		1<<8   	@ GPIOI Enable
RCC_AHB1ENR_GPIOJ_EN	=		1<<9   	@ GPIOJ Enable
RCC_AHB1ENR_GPIOK_EN	=		1<<10   @ GPIOK Enable

RCC_AHB1ENR_CRCEN		=		1<<12   @ CRC Enable
RCC_AHB1ENR_BKPSRAMEN	=		1<<18   @ BKPSRAMEN Backup SRAM interface clock enable
RCC_AHB1ENR_DTCMRAMEN	=		1<<20   @ DTCMRAM Enable
RCC_AHB1ENR_DMA1EN		=		1<<21	@ DMA1 Enable
RCC_AHB1ENR_DMA2EN		=		1<<22	@ DMA2 Enable
RCC_AHB1ENR_DMA2DEN		=		1<<23	@ DMA2D clock Enable
RCC_AHB1ENR_ETHMACEN	=		1<<25	@ ETHMACEN Enable
RCC_AHB1ENR_ETHMACTXEN	=		1<<26	@ ETHMACTXEN Enable
RCC_AHB1ENR_ETHMACRXEN	=		1<<27	@ ETHMACRXEN Enable
RCC_AHB1ENR_ETHMACPTPEN	=		1<<28	@ ETHMACPTPEN Enable
RCC_AHB1ENR_OTGHSEN		=		1<<29	@ USB OTG HS clock Enable
RCC_AHB1ENR_OTGHSULIEN	=		1<<28	@ USB OTG HSULPI clock Enable

@
@ RCC_AHB2ENR AHB2 Peripheral clock enable register values
@

RCC_AHB2ENR_DCMIEN		=		1<<0   	@ Camera interface enable
RCC_AHB2ENR_JPEGEN		=		1<<1	@ JPEG module clock Enable
RCC_AHB2ENR_CRYPEN		=		1<<4	@ Cryptographic modules clock Enable
RCC_AHB2ENR_HASHEN		=		1<<5	@ HASH modules clock Enable
RCC_AHB2ENR_RNGEN		=		1<<6	@ RNG Enable
RCC_AHB2ENR_OTGFSEN		=		1<<7	@ USB OTG FS clock Enable


MODER3_OUT			=		1<<6	// Bit 6 is MODER3[1:0]     01 = output
MODER3_OUT			=		1<<6	// Bit 6 is MODER3[1:0]     01 = output

RED_LED_ON			=		GPIOx_ODR_OD14	@ User LED3 Connected to GPIO PB14
GREEN_LED_ON		=		GPIOx_ODR_OD5	@ User LED1 Connected to GPIO PA5
BLUE_LED_ON			=		GPIOx_ODR_OD7	@ User LED3 Connected to GPIO PB7
...
@
USART_SR_OFFSET				= 0x00
USART_DR_OFFSET				= 0x04
USART_BRR_OFFSET			= 0x08
USART_CR1_OFFSET			= 0x0c
USART_CR2_OFFSET			= 0x10
USART_CR3_OFFSET			= 0x14
USART_GTPR_OFFSET			= 0x18
...
USART1_TD					= (USART1_BASE + USART_TD_OFFSET)
...
USART_BRR_DIV_Fraction_Msk	= (0x03 << USART_BRR_DIV_Fraction_Pos)
USART_BRR_DIV_Fraction		= USART_BRR_DIV_Fraction_Msk

USART_BRR_DIV_Mantissa_Pos	= 4
USART_BRR_DIV_Mantissa_Msk	= (0xfff << USART_BRR_DIV_Mantissa_Pos)
...
USART2_SR					= (USART2_BASE + USART_SR_OFFSET)
USART2_SR_PE				= (0x01 << 0)
USART2_SR_FE				= (0x01 << 1)
USART2_SR_NF				= (0x01 << 2)
USART2_SR_ORE				= (0x01 << 3)
USART2_SR_IDLE				= (0x01 << 4)
USART2_SR_RXNE				= (0x01 << 5)
USART2_SR_TC				= (0x01 << 6)
USART2_SR_TXE				= (0x01 << 7)
USART2_SR_LBD				= (0x01 << 8)
USART2_SR_CTS				= (0x01 << 9)


USART2_RDR					= (USART2_BASE + USART_RDR_OFFSET)

USART2_DR					= (USART2_BASE + USART_DR_OFFSET)

@
@ Random number generator Control Register
@
RNG_CR_BASE					= 0x50060800
RNG_CR_OFFSET				= 0x00
RNG_CR						= (RNG_CR_BASE + RNG_CR_OFFSET)

RNG_CR_RNGEN				= (0x01 << 2)		// True random number generator
RNG_CR_IEEN					= (0x01 << 3)		// Interrupt enable
RNG_CR_CED					= (0x01 << 5)		// Clock error detection
